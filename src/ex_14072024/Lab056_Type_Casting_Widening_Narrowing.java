...
public class Lab056_Type_Casting_Widening_Narrowing {
    public static void main(String[] args) {
       ...
       byte b1 = (byte)val;//Invalid - expicit Casting // Loss of the data
         // 300 = b it will take 128 whatever it will store it will store and rest of values will overflow
        System.out.println(b1);

        // rapidtables.com

        // int = 32 bits byte = 8 bits , it will take last 8 bits and rest of the values will overflow
