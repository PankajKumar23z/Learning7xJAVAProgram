...
public class Lab074_StringCreation_SCP_HA {
    public static void main(String[] args) {
        ...
        System.out.println(name == name1);  // name and name1 are both same ( check for ref they pointed to same)
        ...
        // only 2 string will be created in Heap area
        ...
        System.out.println(name1.equals(name2)); // check for the content they are same
